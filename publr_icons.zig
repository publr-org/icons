// Generated by scripts/build.zig; do not edit.

pub const view_box = "0 0 24 24";
pub const Name = enum { accordion, alert_hexagon, alert_triangle, align_baseline, align_center, align_end, align_start, align_stretch, arrow_left, audio, bleed_both, bleed_left, bleed_none, bleed_right, bold, bookmark, border_radius_bottom_left, border_radius_bottom_right, border_radius_corner, border_radius_none, border_radius_top_left, border_radius_top_right, button, buttons, calendar_check_02, calendar_check, caption, chart, check, chevron_down, chevron_left, chevron_right, chevron_up, clock_check, clock_rewind, close, code, column, columns, components, container_sizes, container_width, copy, cover, decorative, details, device_desktop, device_mobile, device_tablet, dot_filled, dot_half, dot_outline, duplicate, edit, element_typography, external, file, filter_lines, folder_plus, folder, fonts_icons, gallery, globe, grid, grip_vertical, group_blocks, group, heading_level_1, heading_level_2, heading_level_3, heading_level_4, heading_level_5, heading_level_6, heading, home, html, icon, image, info_circle, italic, justify_around, justify_between, justify_center, justify_end, justify_evenly, justify_start, layout, link, list_item, list_ordered, list_unordered, list_view, list, loader, lock, logout, math, media_text, menu_03, moon, more, package, palette, paragraph, pattern_library, pattern, plus_circle, plus, preformatted, primitive_blocks, pullquote, quote, redo, replace, reset, responsive, row, search, semantic_colors, separator, settings, share_04, share, sidebar_right, spacer, spacing_sides_bottom, spacing_sides_left, spacing_sides_none, spacing_sides_right, spacing_sides_top, spacing_sync_left_right, spacing_sync_top_bottom, stack, sun, symbol, sync, table, tag, text_align_center, text_align_left, text_align_right, token_library, trash, undo, ungroup, upload, user, users, verse, video, viewport_compare, viewport_fit, wrap_none, wrap_reverse, wrap, x_close };
...
pub const align_baseline: []const u8 =
    \\<path d="M3.5 17.5H20.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="7" y="6" width="2.5" height="10" rx="1" fill="currentColor"/>
    \\<rect x="14.5" y="10" width="2.5" height="6" rx="1" fill="currentColor"/>
;

pub const align_center: []const u8 =
    \\<path d="M3.5 12H20.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="7" y="7" width="2.5" height="10" rx="1" fill="currentColor"/>
    \\<rect x="14.5" y="9" width="2.5" height="6" rx="1" fill="currentColor"/>
;

pub const align_end: []const u8 =
    \\<path d="M3.5 19.5H20.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="7" y="7.5" width="2.5" height="10" rx="1" fill="currentColor"/>
    \\<rect x="14.5" y="11.5" width="2.5" height="6" rx="1" fill="currentColor"/>
;

pub const align_start: []const u8 =
    \\<path d="M3.5 4.5H20.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="7" y="6.5" width="2.5" height="10" rx="1" fill="currentColor"/>
    \\<rect x="14.5" y="6.5" width="2.5" height="6" rx="1" fill="currentColor"/>
;

pub const align_stretch: []const u8 =
    \\<path d="M3.5 4.5H20.5M3.5 19.5H20.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="7" y="6.5" width="2.5" height="11" rx="1" fill="currentColor"/>
    \\<rect x="14.5" y="6.5" width="2.5" height="11" rx="1" fill="currentColor"/>
;
...
pub const bleed_both: []const u8 =
    \\<path d="M3 5H21M3 19H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<path d="M3 8H21V16H3V8Z" fill="currentColor"/>
;

pub const bleed_left: []const u8 =
    \\<path d="M3 5H21M3 19H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<path d="M3 8H17V16H3V8Z" fill="currentColor"/>
;

pub const bleed_none: []const u8 =
    \\<path d="M3 5H21M3 19H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="7" y="8" width="10" height="8" rx="1.25" fill="currentColor"/>
;

pub const bleed_right: []const u8 =
    \\<path d="M3 5H21M3 19H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<path d="M7 8H21V16H7V8Z" fill="currentColor"/>
;
...
pub const border_radius_bottom_left: []const u8 =
    \\<path d="M4 10V8C4 5.79086 5.79086 4 8 4H10M14 4H16C18.2091 4 20 5.79086 20 8V10M20 14V16C20 18.2091 18.2091 20 16 20H14M10 20H8C5.79086 20 4 18.2091 4 16V14" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
    \\<path d="M10 20H8C5.79086 20 4 18.2091 4 16V14" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
;

pub const border_radius_bottom_right: []const u8 =
    \\<path d="M4 10V8C4 5.79086 5.79086 4 8 4H10M14 4H16C18.2091 4 20 5.79086 20 8V10M20 14V16C20 18.2091 18.2091 20 16 20H14M10 20H8C5.79086 20 4 18.2091 4 16V14" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
    \\<path d="M20 14V16C20 18.2091 18.2091 20 16 20H14" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
;

pub const border_radius_corner: []const u8 =
...
pub const border_radius_none: []const u8 =
    \\<path d="M4 10V8C4 5.79086 5.79086 4 8 4H10M14 4H16C18.2091 4 20 5.79086 20 8V10M20 14V16C20 18.2091 18.2091 20 16 20H14M10 20H8C5.79086 20 4 18.2091 4 16V14" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
;

pub const border_radius_top_left: []const u8 =
    \\<path d="M4 10V8C4 5.79086 5.79086 4 8 4H10M14 4H16C18.2091 4 20 5.79086 20 8V10M20 14V16C20 18.2091 18.2091 20 16 20H14M10 20H8C5.79086 20 4 18.2091 4 16V14" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
    \\<path d="M4 10V8C4 5.79086 5.79086 4 8 4H10" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
;

pub const border_radius_top_right: []const u8 =
    \\<path d="M4 10V8C4 5.79086 5.79086 4 8 4H10M14 4H16C18.2091 4 20 5.79086 20 8V10M20 14V16C20 18.2091 18.2091 20 16 20H14M10 20H8C5.79086 20 4 18.2091 4 16V14" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
    \\<path d="M14 4H16C18.2091 4 20 5.79086 20 8V10" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
;
...
pub const container_sizes: []const u8 =
    \\<path d="M8 5h8M8 19h8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="3.5" y="8.5" width="17" height="7" rx="1.5" stroke="currentColor" stroke-width="1.5"/>
;

pub const container_width: []const u8 =
    \\<path d="M8 5H16M8 19H16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<rect x="5" y="9" width="14" height="6" rx="1" fill="currentColor"/>
;
...
pub const device_desktop: []const u8 =
...
pub const device_mobile: []const u8 =
...
pub const device_tablet: []const u8 =
...
pub const element_typography: []const u8 =
    \\<path d="M3.5 18.5 8.25 5.5 13 18.5M5.25 13.75h6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    \\<path d="M20.5 11.25v7.25M20.5 16.75a3.5 3.5 0 1 1 0-4.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
;
...
pub const filter_lines: []const u8 =
...
pub const fonts_icons: []const u8 =
    \\<path d="M3.5 17.5 8 6.5l4.5 11M5.25 13.25h5.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    \\<path d="m17.25 7 3.75 5-3.75 5-3.75-5 3.75-5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
;
...
pub const grip_vertical: []const u8 =
...
pub const info_circle: []const u8 =
...
pub const justify_around: []const u8 =
    \\<path d="M3.5 5v14M20.5 5v14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<g fill="currentColor">
    \\<rect x="5.25" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="10.5" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="15.75" y="8.5" width="3" height="7" rx="1"/>
    \\</g>
;

pub const justify_between: []const u8 =
    \\<path d="M3.5 5v14M20.5 5v14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<g fill="currentColor">
...
pub const justify_center: []const u8 =
    \\<path d="M3.5 5v14M20.5 5v14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<g fill="currentColor">
    \\<rect x="6.75" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="10.5" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="14.25" y="8.5" width="3" height="7" rx="1"/>
    \\</g>
;

pub const justify_end: []const u8 =
    \\<path d="M20.5 5v14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<g fill="currentColor">
    \\<rect x="7" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="11.5" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="16" y="8.5" width="3" height="7" rx="1"/>
    \\</g>
;

pub const justify_evenly: []const u8 =
    \\<path d="M3.5 5v14M20.5 5v14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<g fill="currentColor">
    \\<rect x="5.75" y="8.5" width="2.5" height="7" rx="1"/>
    \\<rect x="10.75" y="8.5" width="2.5" height="7" rx="1"/>
    \\<rect x="15.75" y="8.5" width="2.5" height="7" rx="1"/>
    \\</g>
;

pub const justify_start: []const u8 =
    \\<path d="M3.5 5v14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<g fill="currentColor">
    \\<rect x="5" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="9.5" y="8.5" width="3" height="7" rx="1"/>
    \\<rect x="14" y="8.5" width="3" height="7" rx="1"/>
    \\</g>
;
...
pub const loader: []const u8 =
    \\<circle cx="12" cy="12" r="9" stroke="currentColor" stroke-opacity=".25" stroke-width="2.5"/>
...
pub const palette: []const u8 =
    \\<path d="M12 3.75a8.25 8.25 0 1 0 0 16.5h1.25a1.75 1.75 0 0 0 0-3.5h-.65a1.6 1.6 0 0 1 0-3.2h2.9A4.75 4.75 0 0 0 20.25 8.8 5.05 5.05 0 0 0 15.2 3.75H12Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    \\<circle cx="8" cy="9" r=".8" fill="currentColor"/>
    \\<circle cx="11" cy="6.8" r=".8" fill="currentColor"/>
    \\<circle cx="15" cy="7.3" r=".8" fill="currentColor"/>
;
...
pub const pattern_library: []const u8 =
    \\<rect x="3.5" y="3.5" width="17" height="17" rx="2" stroke="currentColor" stroke-width="1.5"/>
    \\<rect x="6.5" y="6.5" width="4" height="4" rx=".75" fill="currentColor"/>
    \\<rect x="13.5" y="6.5" width="4" height="4" rx=".75" fill="currentColor" fill-opacity=".35"/>
    \\<rect x="6.5" y="13.5" width="11" height="4" rx=".75" fill="currentColor" fill-opacity=".65"/>
;
...
pub const primitive_blocks: []const u8 =
    \\<rect x="3.5" y="4.5" width="17" height="15" rx="2" stroke="currentColor" stroke-width="1.5"/>
    \\<rect x="7" y="9.5" width="10" height="5" rx="2.5" fill="currentColor"/>
;
...
pub const responsive: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    \\<path d="M3.75 6.75h4.5A3.75 3.75 0 0 1 12 10.5v3"/>
    \\<path d="M12 13.5a3.75 3.75 0 0 0 3.75 3.75h4.5"/>
    \\<path d="M12 13.5a3.75 3.75 0 0 1 3.75-3.75h4.5"/>
    \\<circle cx="3.75" cy="6.75" r="1.5"/>
    \\<circle cx="20.25" cy="9.75" r="1.5"/>
    \\<circle cx="20.25" cy="17.25" r="1.5"/>
    \\</g>
;
...
pub const semantic_colors: []const u8 =
    \\<rect x="3.5" y="3.5" width="17" height="17" rx="2" stroke="currentColor" stroke-width="1.5"/>
    \\<rect x="6.5" y="6.5" width="4" height="4" rx=".75" fill="currentColor"/>
    \\<rect x="13.5" y="6.5" width="4" height="4" rx=".75" fill="currentColor" fill-opacity=".35"/>
    \\<rect x="6.5" y="13.5" width="4" height="4" rx=".75" fill="currentColor" fill-opacity=".35"/>
    \\<rect x="13.5" y="13.5" width="4" height="4" rx=".75" fill="currentColor"/>
;
...
pub const sidebar_right: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    \\<rect x="3.5" y="4.5" width="17" height="15" rx="2"/>
    \\<path d="M15.5 4.5v15"/>
    \\</g>
...
pub const spacing_sides_bottom: []const u8 =
    \\<path d="M8 4H16M20 8V16M8 20H16M4 8V16" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round"/>
    \\<path d="M8 20H16" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
;

pub const spacing_sides_left: []const u8 =
    \\<path d="M8 4H16M20 8V16M8 20H16M4 8V16" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round"/>
    \\<path d="M4 8V16" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
;

pub const spacing_sides_none: []const u8 =
    \\<path d="M8 4H16M20 8V16M8 20H16M4 8V16" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round"/>
;

pub const spacing_sides_right: []const u8 =
    \\<path d="M8 4H16M20 8V16M8 20H16M4 8V16" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round"/>
    \\<path d="M20 8V16" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
;

pub const spacing_sides_top: []const u8 =
    \\<path d="M8 4H16M20 8V16M8 20H16M4 8V16" stroke="var(--publr-icon-guide, #666666)" stroke-width="2.25" stroke-linecap="round"/>
    \\<path d="M8 4H16" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
;

pub const spacing_sync_left_right: []const u8 =
    \\<path d="M3.5 7.5V16.5M20.5 7.5V16.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<path d="M7 12H17M9.5 9.5L7 12L9.5 14.5M14.5 9.5L17 12L14.5 14.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
;

pub const spacing_sync_top_bottom: []const u8 =
    \\<path d="M7.5 3.5H16.5M7.5 20.5H16.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    \\<path d="M12 7V17M9.5 9.5L12 7L14.5 9.5M9.5 14.5L12 17L14.5 14.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
;
...
pub const text_align_center: []const u8 =
    \\<path d="M3 5.25h18M6.75 12h10.5M4.5 18.75h15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
;

pub const text_align_left: []const u8 =
    \\<path d="M3 5.25h18M3 12h10.5M3 18.75h15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
;

pub const text_align_right: []const u8 =
    \\<path d="M3 5.25h18M10.5 12H21M6 18.75h15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
;

pub const token_library: []const u8 =
    \\<path d="M9 4.5H7.75A1.75 1.75 0 0 0 6 6.25v3.25A2.5 2.5 0 0 1 3.5 12 2.5 2.5 0 0 1 6 14.5v3.25a1.75 1.75 0 0 0 1.75 1.75H9M15 4.5h1.25A1.75 1.75 0 0 1 18 6.25v3.25a2.5 2.5 0 0 0 2.5 2.5 2.5 2.5 0 0 0-2.5 2.5v3.25a1.75 1.75 0 0 1-1.75 1.75H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
;
...
pub const viewport_compare: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    \\<rect x="2.75" y="5.5" width="5.5" height="13" rx="1.25"/>
    \\<rect x="9.25" y="4" width="5.5" height="16" rx="1.25"/>
    \\<rect x="15.75" y="2.5" width="5.5" height="19" rx="1.25"/>
    \\</g>
;

pub const viewport_fit: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
pub const wrap_none: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    \\<rect x="3" y="5" width="6" height="14" rx="2"/>
    \\<rect x="10.5" y="5" width="6" height="14" rx="2"/>
    \\<path d="M18.5 5H21L18.75 9.5 21 12 18.75 14.5 21 19H18.5"/>
    \\</g>
;

pub const wrap_reverse: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    \\<rect x="3" y="3.5" width="6.5" height="6.5" rx="2"/>
    \\<rect x="3" y="12.5" width="6.5" height="6.5" rx="2"/>
    \\<rect x="11.5" y="12.5" width="6.5" height="6.5" rx="2"/>
    \\<path d="M19.5 13.5V10C19.5 7.25 17.25 5 14.5 5H11M13.5 2.5 11 5l2.5 2.5"/>
    \\</g>
;

pub const wrap: []const u8 =
    \\<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    \\<rect x="3" y="3.5" width="6.5" height="6.5" rx="2"/>
    \\<rect x="11.5" y="3.5" width="6.5" height="6.5" rx="2"/>
    \\<rect x="3" y="12.5" width="6.5" height="6.5" rx="2"/>
    \\<path d="M19.5 10.5V14C19.5 16.75 17.25 19 14.5 19H11M13.5 16.5 11 19l2.5 2.5"/>
    \\</g>
;
